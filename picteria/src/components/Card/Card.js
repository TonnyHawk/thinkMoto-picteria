...
class Card extends Component {
   ...
   componentDidMount() {
      ['dragenter', 'dragover', 'dragleave', 'drop'].forEach(eventName => {
         this.dropArea.current.addEventListener(eventName, preventDefaults, false)
      })
      ...
      return (
         ...
         <div className="card__body">
            ...
            <div className="card__files">
               ...
               <div className="card__file file">
                  <div className="file__icon file__icon--jpg"></div>
                  <div className="file__info">
                     <div className="flex justify-content-between">
                        <p className="file__name">my_new_screen-shot</p>
                        <div className="file__progress-indicator">
                           <p className="file__progress-indicator-txt">45%</p>
               ...
               <div className="card__file file">
                  <div className="file__icon file__icon--webp"></div>
                  <div className="file__info">
                     <div className="flex justify-content-between">
                        <p className="file__name">my_new_screen-shot</p>
                        <div className="file__progress-indicator">
               ...
               <div className="card__file file">
                  <div className="file__icon file__icon--png"></div>
                  <div className="file__info">
                     <div className="flex justify-content-between">
                        <p className="file__name">my_new_screen-shot</p>
                        <div className="file__progress-indicator">
         ...
         <div className="card__footer">
            <p className="btn is-disabled">Upload</p>
         </div>
      </div>
      );
   }
